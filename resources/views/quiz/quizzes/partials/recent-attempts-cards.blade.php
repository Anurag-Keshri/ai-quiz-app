		...
		<div class="card bg-base-100 shadow-xl border border-base-300">
			<div class="card-body">
				...
				<div class="flex justify-between items-start">
					<div>
						<h3 class="card-title">{{ $attempt->quiz->author->name }}</h3>
						<p class="text-base-content/70 mt-1">{{ $attempt->quiz->author->email }}</p>
					</div>
						...
						@if(Gate::allows('delete', $attempt))
							...
							>
								...
								<button type="submit" class="btn btn-outline btn-error btn-sm">
									...
									<span class="hidden min-[400px]:block">Delete</span>
								</button>
							</form>
						@endif
					</div>
