        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="stats shadow bg-base-100 border border-base-300">
                <div class="stat">
                    ...
                    <div class="stat-value">{{ round($quiz->attempts->avg('score')) }}%</div>
                    <div class="stat-desc">Based on {{ $quiz->attempts->count() }} attempts</div>
                </div>
            </div>
            ...
            <div class="stats shadow bg-base-100 border border-base-300">
                <div class="stat">
                    ...
                    <div class="stat-value">{{ $quiz->attempts->max('score') }}%</div>
            ...
            <div class="stats shadow bg-base-100 border border-base-300">
                <div class="stat">
                    ...
                    <div class="stat-value">{{ round(($quiz->attempts->count() / max($quiz->views, 1)) * 100) }}%</div>
            ...
            <div class="card bg-base-100 shadow-xl mt-8 border border-base-300">
                <div class="card-body">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('attempts.index', ['quiz' => $quiz->id]) }}" class="btn btn-outline btn-sm">
                            View All
                        </a>
                    </div>
