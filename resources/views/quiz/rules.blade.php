        ...
        <div class="w-full max-w-md bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 rounded-lg p-4 mt-2">
            <form action="{{ route('quiz.update.rules', $quiz->id) }}" method="POST" id="quizRulesForm" class="space-y-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="time_limit" name="time_limit" min="1" value="{{ $quiz->time_limit }}" class="block w-full mt-1 p-2 border border-gray-700 rounded-lg dark:bg-gray-700 dark:text-gray-200">
                </div>
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <label for="shuffle_questions" class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" id="shuffle_questions" name="shuffle_questions" value="true" {{ $quiz->shuffle_questions ? 'checked' : '' }} class="sr-only peer">
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <label for="shuffle_options" class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" id="shuffle_options" name="shuffle_options" value="true" {{ $quiz->shuffle_options ? 'checked' : '' }} class="sr-only peer">
                        <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                    </label>
                </div>
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <label for="show_score" class="inline-flex items-center cursor-pointer">	
                        <input type="checkbox" id="show_score" name="show_score" value="true" {{ $quiz->show_score ? 'checked' : '' }} class="sr-only peer">
                        <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                    </label>
                </div>
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <label for="show_correct_answer" class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" id="show_correct_answer" name="show_correct_answer" value="true" {{ $quiz->show_correct_answer ? 'checked' : '' }} class="sr-only peer">
                        <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                    </label>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="datetime-local" id="start_datetime" name="start_datetime" value="{{ $quiz->start_datetime }}" class="block w-full mt-1 p-2 border border-gray-700 rounded-lg dark:bg-gray-700 dark:text-gray-200">
                </div>

                <div class="mb-4">
                    <x-input-label for="end_datetime" :value="__('End Date & Time:')" />
                    <input type="datetime-local" id="end_datetime" name="end_datetime" value="{{ $quiz->end_datetime }}" class="block w-full mt-1 p-2 border border-gray-700 rounded-lg dark:bg-gray-700 dark:text-gray-200">
                </div>
